...
import styles from "./RootCamera.module.css";
import { Creativity } from "./Creativity";
import { Prism } from "./Prism";
import { useSubTimelines } from "./hooks/useSubTimelines";

export const RootCamera: SubAnimationFC = (props) => {
  ...
  return (
    <Sketch className={styles.root} hidden={props.hidden}>
      <g className={styles.viewportRoot}>
        <Creativity registerAnimation={registerAnimation("creativity")} onIntendedEnd={props.onIntendedEnd} />
